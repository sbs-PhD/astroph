...
#if RADIO == 48
// For BL Lac 4.8 GHz
#define DIR_FILE "data/PKS1921-293-048GHz-TS.csv"
#define DESTINY "graphics/ov236-048GHz-K_S-scatter.pdf"
#define COLOR_P kRed

#elif RADIO == 80
// For BL Lac 8.0 GHz
#define DIR_FILE "data/PKS1921-293-080GHz-TS.csv"
#define DESTINY "graphics/ov236-080GHz-K_S-scatter.pdf"
#define COLOR_P kBlue

#else // RADIO == 145
// For BL Lac 14.5 GHz
#define DIR_FILE "data/PKS1921-293-145GHz-TS.csv"
#define DESTINY "graphics/ov236-145GHz-K_S-scatter.pdf"
...
void GraphOV236KSFromCSVscatter()
{
